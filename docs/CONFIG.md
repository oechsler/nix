...
| `features.virtualisation.waydroid.enable` | `false` | Waydroid Android container (requires virtualisation.enable + Wayland) |
...
| `features.apps.winboat.enable` | `false` | WinBoat Windows VM (requires apps.enable) |
