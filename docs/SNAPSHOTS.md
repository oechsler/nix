...
is recreated on boot. The Nix store and transient `/var` state are also excluded
because they are managed separately from the standard home and persist snapshots.
