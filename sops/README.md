...
| `user/ldap/uri` | LLDAP URI, e.g. `ldaps://host:6360` | `modules/system/ldap.nix` |
...
| `opencode/mistral/api-key` | Mistral API key for LLM coding assistant | `modules/home-manager/programs/opencode.nix` |
