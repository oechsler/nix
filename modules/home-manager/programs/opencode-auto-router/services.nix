        ...
        "podman-opencode-auto-router" = {
          ...
          Service = {
            ...
            ExecStart = lib.concatStringsSep " " [
              ...
              "-e DEFAULT_MODEL=qwen3.7-plus"
              "-e CLOUD_CLASSIFIER_MODEL=mistral-small"
              "-e PROVIDER_COOLDOWN_BASE_SECONDS=30"
              "-e PROVIDER_COOLDOWN_MAX_SECONDS=300"
              "-e AUTH_BAN_SECONDS=600"
              "-e EXHAUSTION_BAN_SECONDS=900"
              "-e SESSION_QUALITY_BAN_SECONDS=600"
              "-e MODEL_ROTATION_BAN_SECONDS=120"
              "-e MODEL_MAX_CONSECUTIVE=15"
