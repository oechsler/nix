# Hyprland window manager configuration and session services.
#
# Supporting modules are imported by module-imports.nix. This module owns:
# - Hyprland settings and keybindings
# - Internal user services for the graphical session
#
# Key features:
        ...
        map (app: {
          ...
          value = {
            ...
            Service = {
              ...
              ExecStart = delayedAutostart app;
